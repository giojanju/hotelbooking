	...
	<div class="container-fluid">
		<div class="panel panel-headline">
			...
			<div class="panel-body">
				...
				<form method="POST" class="form-auth-small" action="{{ route('cp.days.store') }}">
                    @csrf
						<div>
						  	<!-- Nav tabs -->
							...
							<div class="tab-content">
							    ...
							    @endforeach
					    		<div class="form-group">
			                        <label for="name" class="control-label">Select tour</label>
			                        <select name="tour_id" id="tour_id" class="form-control">
										<option value="" >Select tour</option>
			                        	@foreach($tours as $tour)
			                        		<option value="{{ og($tour, 'id') }}">{{ og($tour, 'title') }}</option>
			                        	@endforeach
			                        </select>
