	...
	<div class="container-fluid">
		<div class="panel panel-headline">
			...
			<div class="panel-body">
				...
				<form method="POST" class="form-auth-small" action="{{ route('cp.hotel_services.update', [og($hotel_service, 'id')]) }}">
                    @csrf
                    	<div class="form-group">
                    	    <label for="ge.title" class="control-label sr-only">Service title</label>
                    	    <input type="text" name="ge[title]" class="form-control{{ $errors->has('ge.title') ? ' parsley-error' : '' }}" id="ge.title" value="{{ og($hotel_service, 'ge.title') }}" placeholder="Service title">
