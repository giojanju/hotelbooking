...
// Cars
Route::get('cars/{id}', 'HomeController@getCars')->name('cars');
Route::get('car/{id}', 'HomeController@getCarSingleCar')->name('car.single');
...
Route::prefix('cp')->middleware('auth')->name('cp.')->namespace('Cp')->group(function () {
	...
	Route::prefix('modules')->name('modules.')->namespace('Modules')->group(function () {
		// 
	});
